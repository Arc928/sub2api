          ...
          <div class="relative overflow-hidden border-b border-hairline bg-canvas px-6 py-5 dark:border-dark-600 dark:bg-dark-800">
            <div class="relative z-10">
              ...
              <div class="mb-3 flex items-center gap-2">
                ...
                <span class="inline-flex items-center gap-1.5 rounded-sm bg-ink px-2.5 py-1 text-xs font-medium text-canvas dark:bg-gray-100 dark:text-ink">
          ...
          <div class="border-t border-gray-100 bg-gray-50/50 px-8 py-5 dark:border-dark-700 dark:bg-dark-900/30">
            <div class="flex items-center justify-end">
              <button
                ...
                class="rounded-sm bg-ink px-6 py-2.5 text-sm font-medium text-canvas transition-colors hover:bg-charcoal active:bg-ink-deep dark:bg-gray-100 dark:text-ink dark:hover:bg-white"
              >
